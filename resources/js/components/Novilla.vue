<template>
    <div class="container" id="label">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active">Sección de Novillas</li>
        </ol>
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <input v-model="novilla.nombre" type="number" min="1" max="9999" class="form-control" id="nombre" placeholder="Nombre">
                </div>
                 <div class="mb-3">
            ...
            <tbody>
                <tr v-for="(novilla, item) in novillas.data" :key="novilla.id">
                    ...
                    <td class="text-center">
                        <button @click="modificar=true; modificarCrecimiento=false; abrirModal(novilla); showDialog(true);" class="btn btn-outline-warning"><i class="fas fa-edit"></i></button>
...
export default {
    data() {
        return {
            ...
            opciones: [
                { text: 'Novillo(a)', value: '1' },
                { text: 'Vaca-Toro', value: '2' },
            ],
            id:0,
            modificar:true,
    ...
    methods:{
        async listar(){
            const res = await axios.get('/api/novillas',{params: this.pagination});
        ...
        async guardar(){
            try {
                ...
                if (this.modificarCrecimiento) {
                    ...
                    const res = await axios.put('/api/novillas/'+ this.id, data);
                    ...
                    datos.append('imagen', this.novilla.imagen);
                    ...
                    datos.append('valor_Vendido', this.novilla.valor_Vendido);
                    ...
                    axios({
                        ...
                        .then(response=>{ 
                        const res = axios.put('/api/novillas/'+ this.id, data);    
                        this.$swal({icon:'success', title:'Exito!', text:'El novillo(a) ha pasado a la vista de Vacas'})
                        this.cerrarModal();
                        this.listar();
                    })
                    .catch(error=>{
                    ...
                    if (this.novilla.nombre == ''|| this.novilla.imagen=='') {
                    ...
                    axios.defaults.withCredentials = true;
                    axios.post('/api/novillas/'+ this.id, datos,
                    {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        },
                ...
                if (this.novilla.nombre == ''|| this.novilla.imagen=='') {
                    ...
                    .then(response=>{ 
                        this.$swal({icon:'success', title:'Exito!', text:'Se agrego correctamente la novilla(o)'})
                        this.cerrarModal();
                        this.listar();
                    })
                    .catch(error=>{
        ...
        fallecida(id){
            try {
                ...
                if (result.isConfirmed) {
                    const res =  axios.put('/api/novillas/'+id, data);
                    this.listar();
                    this.$swal(
                    '¡Falleció!',
                    'El novillo(a) ha pasado a la vista de fallecidos',
                    'success'
                    )}
                })
            } catch (error) {
            ...
            try {
                ...
                this.$swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        this.$swal(
                        '¡Vendido!',
                        'El novillo(a) ha pasado a la vista de vendidos',
                        'success'
                        )
